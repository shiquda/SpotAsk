---
title: Explore SpotAsk
description: A capability map for the questions, selection, model, attachment, prompt, shortcut, and system workflows in SpotAsk.
---

# Explore SpotAsk

Use this page as a map of what SpotAsk can do. Pick a task instead of a setting; each section explains when it is useful and where to start.
