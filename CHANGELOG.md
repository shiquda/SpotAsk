...
- In existing conversations, the preset popover menu now lists enabled External Ask targets alongside prompt presets, and External Ask shortcuts attach a pending badge that launches on send.
### Changed
