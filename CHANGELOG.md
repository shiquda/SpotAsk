...
- Configurable update download sources (Official GitHub, FastGit, Cloudflare mirror) in Settings > About > Updates with automatic timeout detection and mirror fallback for reliable downloads in all regions.
